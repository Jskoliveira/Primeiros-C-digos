...
- A mensagem "código <código> não encontrado" (sem aspas), quando o comando remover for executado com um código que não esteja no carrinho. Substitua <código> pelo código não encontrado.

Observação: Lembre-se de não exibir texto no input.



![image-20220120151826158](C:\Users\jskol\AppData\Roaming\Typora\typora-user-images\image-20220120151826158.png)